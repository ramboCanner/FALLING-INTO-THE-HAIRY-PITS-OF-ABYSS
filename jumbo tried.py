...
clinton = pygame.mixer.Sound('relations.ogg')
...
yoshi.load("yoshi.png",425,60,1) #hashtag
...
##    pygame.draw.line(screen,red,(0,hei - 40), (wid,hei - 40),100)
    ...
    for sdfkla in woh:
            if(rogord.X < wid - 75 and rogord.X > 10):
                dying = True
                sooper = True
...
##                ysp = yoko
            ...
            if event.key == pygame.K_a:
                ...
                #ropey.frame = ropey.frame + 1
                #ropey.first_frame = ropey.frame
                #ropey.last_frame = ropey.frame
                #print("if ropey.frame = " + str(ropey.frame) + ":")
                #print("\trogord.X= " + str(rogord.X))
                #print("\trogord.Y = " + str(rogord.Y))
                if(men.frame < 5):
